...
const instructions: Record<Platform, { steps: string[]; tip?: string }> = {
  mac: {
    steps: [
      ...
      "点击“Copy as Pathname”，然后粘贴到这里。",
    ],
    tip: "你也可以打开 Terminal，输入 cd，把文件夹拖进终端窗口并回车。随后输入 pwd，即可看到完整路径。",
  },
  windows: {
    steps: [
      "打开文件资源管理器并进入目标文件夹。",
    ...
    tip: "也可以按住 Shift 后右键点击文件夹，再选择“Copy as path”。",
  },
  linux: {
    steps: [
      "打开终端，使用 cd 进入目标目录。",
    ...
    tip: "在大多数文件管理器里，按 Ctrl+L 也能在地址栏中显示完整路径。",
  },
};
