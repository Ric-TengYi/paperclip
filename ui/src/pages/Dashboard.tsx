...
export function Dashboard() {
  ...
  if (!selectedCompanyId) {
    if (companies.length === 0) {
      return (
        <EmptyState
          ...
          message="欢迎使用 Paperclip。先创建第一家公司和第一个 Agent，即可开始。"
          action="开始使用"
    ...
    return (
      <EmptyState icon={LayoutDashboard} message="创建或选择一家公司后，即可查看仪表盘。" />
    );
  }
      ...
      {data && (
        <>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="text-sm font-medium text-red-50">
                    {data.budgets.activeIncidents} 个预算事件正在处理中
                  </p>
              ...
              description={
                <span>
                  {data.budgets.pendingApprovals > 0
                    ? `${data.budgets.pendingApprovals} 个预算覆盖等待 board 审核`
                    : "等待 board 审核"}
                </span>
              }
            />
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <ChartCard title="按优先级统计的任务" subtitle="最近 14 天">
              <PriorityChart issues={issues ?? []} />
            </ChartCard>
            <ChartCard title="按状态统计的任务" subtitle="最近 14 天">
            ...
            <div className="min-w-0">
              ...
              {recentIssues.length === 0 ? (
                <div className="border border-border p-4">
                  <p className="text-sm text-muted-foreground">当前还没有任务。</p>
                </div>
              ) : (
                <div className="border border-border divide-y divide-border overflow-hidden">
