      ...
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            {challengeQuery.error instanceof Error ? challengeQuery.error.message : "该请求无效或已过期。"}
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Paperclip CLI 现在可以在发起请求的设备上完成认证。
          </p>
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          本地 Paperclip CLI 进程正在请求访问此实例的 Board。
        </p>
        ...
        <div className="mt-5 space-y-3 text-sm">
          ...
          <div>
            <div className="text-muted-foreground">请求的访问级别</div>
            <div className="text-foreground">
              {challenge.requestedAccess === "instance_admin_required" ? "实例管理员 Instance admin" : "Board"}
            </div>
          </div>
        ...
        {!challenge.canApprove && (
          <p className="mt-4 text-sm text-destructive">
            该请求需要 instance-admin 权限。请使用实例管理员账户登录后批准。
          </p>
        )}
